  ...
  return (
    <div className="flex flex-col">
      <div className={`group flex items-center justify-between py-3 border-b hover:border-[var(--cyber-neon-blue)]/30 transition-colors ${isActive ? 'border-[var(--cyber-neon-blue)] bg-[var(--cyber-neon-blue)]/5' : 'border-[var(--border-light)]'}`}>
        ...
        >
          <span className={`text-xs font-mono mb-0.5 ${isActive ? 'text-[var(--cyber-neon-blue)]' : 'text-[var(--cyber-neon-blue)]/80'}`}>0{index + 1}</span>
    ...
    <div className="min-h-screen bg-[var(--bg-color)] text-[var(--text-color)]">
            ...
            >
              <div className="h-[64px] flex items-center justify-between px-4 sm:px-8 border-b border-[var(--border-light)]">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-cyber font-bold text-[var(--cyber-neon-blue)] text-xs tracking-[0.2em] uppercase">Navigation</span>
                </div>
                <button
                  onClick={() => setIsMenuOpen(false)}
              ...
              <div className="p-8 border-t border-[var(--border-light)] bg-[var(--overlay-bg)]">
                <div className="text-xs font-mono text-[var(--text-dim)] uppercase tracking-widest mb-4">Quick Links</div>
        ...
        {location.pathname !== '/' && (
          <div className="max-w-7xl mx-auto px-4 sm:px-8 py-12 flex justify-between items-center border-t border-[var(--border-light)]">
            {prevNav ? (
              ...
              >
                <span className="text-xs font-mono text-[var(--text-dim)] uppercase tracking-[0.2em]">Previous</span>
                <div className="flex items-center gap-2 text-[var(--text-color)] group-hover:text-[var(--cyber-neon-blue)]">
                  <ChevronLeft className="w-5 h-5 group-hover:-translate-x-1 transition-transform" />
                  <span className="font-cyber font-bold text-sm tracking-wider uppercase">{prevNav.label}</span>
                </div>
              </Link>
            ) : (
              <div />
            ...
            {nextNav ? (
              ...
              >
                <span className="text-xs font-mono text-[var(--text-dim)] uppercase tracking-[0.2em]">Next</span>
                <div className="flex items-center gap-2 text-[var(--text-color)] group-hover:text-[var(--cyber-neon-blue)]">
                  <span className="font-cyber font-bold text-sm tracking-wider uppercase">{nextNav.label}</span>
      ...
      {location.pathname !== '/' && (
        <footer className="py-12 border-t border-[var(--border-light)] px-4 sm:px-8 flex flex-col items-center gap-4 bg-[var(--bg-color)]">
          ...
          <p className="text-xs font-mono text-[var(--text-dim)] uppercase tracking-[0.2em]">Created by KMCD.DEV</p>
        </footer>
      )}
    </div>
  );
