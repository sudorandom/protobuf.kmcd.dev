...
import { ZigZagExplainer } from "../components/ZigZagExplainer";
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 relative">
          ...
          {/* Left: Input */}
          <div className="space-y-8">
            <CyberPanel title="JSON_INPUT" className="h-full">
    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-32 pt-24 border-t border-[var(--border-light)]/30 space-y-16">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              <h3 className="text-3xl font-cyber font-bold text-[var(--text-color)] uppercase tracking-tight">
                Packed Repeated Fields
              </h3>
              <p className="text-lg text-[var(--text-dim)] leading-relaxed">
                Repeated fields of primitive types use a specialized encoding to
                avoid repeating the field tag for every element.
              </p>
            </div>
            <div className="max-w-4xl mx-auto">
              <PackedRepeatedVisualization />
            </div>
          </div>
        </div>
      </Section>

      {/* 2.5 Maps & Advanced Types */}
      <Section
        id="advanced-types"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto text-center space-y-8 mt-8">
            ...
            <div className="space-y-4 text-left">
              <div className="p-4 bg-[var(--section-bg-dark)] border border-[var(--border-light)] rounded-lg">
                <SyntaxHighlighter
                  language="proto"
                  code="map<string, int32> items = 1;"
                />
              </div>
              <div className="text-[var(--text-dim)] text-sm italic px-2">
                Is equivalent to:
              </div>
              <div className="p-4 bg-[var(--section-bg-dark)] border border-[var(--border-light)] rounded-lg">
                <SyntaxHighlighter
      ...
      >
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="max-w-4xl mx-auto">
            <FieldPresenceVisualization />
          </div>

          <div className="max-w-3xl mx-auto text-[var(--text-dim)] leading-relaxed space-y-4">
            <p>
            ...
            <p>
              ...
              reintroduces <strong>Explicit Presence</strong>. These fields are
