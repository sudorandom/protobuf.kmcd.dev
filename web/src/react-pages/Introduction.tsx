...
import { GeneratingCode } from "./Basics";
      ...
      <Section id="intro" className="py-24 px-4 sm:px-8 max-w-7xl mx-auto">
        ...
        <div className="mb-16 space-y-6">
          ...
          <p className="text-[var(--text-dim)] leading-relaxed">
            Protobuf works by combining a pre-defined <strong>schema</strong>{" "}
            with your <strong>data</strong> to produce a compact binary payload.
            Unlike JSON, which repeats field names in every object, Protobuf
            identifies fields by numeric IDs from the schema. That is the core
            tradeoff: less self-description in each payload, more value from a
            shared contract.
          </p>
          ...
          <CyberPanel title="THE_MANY_FACES_OF_PROTO">
            <div className="p-6 space-y-8">
              <p className="text-sm text-[var(--text-dim)] leading-relaxed">
                ...
                message can be represented across these different
                specifications:
              </p>
