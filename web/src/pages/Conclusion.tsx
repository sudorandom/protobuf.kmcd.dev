...
export const Conclusion = () => (
  <>
    <Section id="conclusion" className="min-h-screen flex flex-col items-center justify-center p-8 bg-[var(--section-bg-dark)]">
      <motion.div
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center">
          <Link to="/" className="px-8 py-3 border border-[var(--cyber-neon-blue)] text-[var(--cyber-neon-blue)] font-cyber font-bold uppercase hover:bg-[var(--cyber-neon-blue)]/10 transition-all flex items-center gap-2 rounded-md">
            <ChevronLeft className="w-5 h-5" />
            Return to Start
          </Link>
          <a href="https://github.com/kmcd-dev/protobuf.kmcd.dev" target="_blank" rel="noopener noreferrer" className="px-8 py-3 bg-[var(--cyber-neon-blue)] text-black font-cyber font-bold uppercase hover:bg-[var(--cyber-neon-blue)]/90 transition-all rounded-md shadow-[0_0_20px_rgba(0,243,255,0.4)]">
            View on GitHub
          </a>
        </div>
      </motion.div>
