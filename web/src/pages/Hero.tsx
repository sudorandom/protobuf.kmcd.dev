...
export const Hero = ({ isAtTop }: { isAtTop: boolean }) => (
  <Section id="hero" className="h-screen flex flex-col items-center justify-center p-4 sm:p-8 pt-[64px] relative overflow-hidden">
    ...
    <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-20">
      <Link to="/intro" className="flex flex-col items-center gap-2 group text-[var(--cyber-neon-blue)] hover:text-[var(--cyber-neon-blue)]/80 transition-colors">
        <span className="font-cyber font-bold tracking-[0.2em] text-xl uppercase">Get Started</span>
