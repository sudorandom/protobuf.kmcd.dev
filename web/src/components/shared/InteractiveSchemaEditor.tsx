        ...
        <div className="flex items-center gap-3">
          ...
          {(onSave || onApply) && (
            <button
              ...
              className="flex items-center gap-2 px-8 py-2 text-sm font-cyber font-bold bg-[var(--cyber-neon-blue)] text-[var(--neon-contrast-text)] hover:bg-[var(--cyber-neon-blue)]/90 transition-all rounded-md uppercase tracking-widest disabled:opacity-30 disabled:cursor-not-allowed shadow-[0_0_15px_rgba(0,243,255,0.3)]"
              aria-label={
