...
export const VarintWireTypeVisualization = () => {
      ...
      >
        <defs>
          ...
          >
            ...
            <stop offset="100%" stopColor="var(--cyber-neon-green)" />
          </linearGradient>
          <filter id="glow-varint" x="-20%" y="-20%" width="140%" height="140%">
        ...
        >
          ...
          <text x="225" y="110" fill="var(--cyber-neon-yellow)" fontSize="14">
            1
          </text>
          <text x="235" y="110" fill="currentColor" fontSize="14">
            ;
          </text>
        ...
        >
          ...
          <text x="475" y="95" fill="currentColor" fontSize="14">
            :
          </text>
          <text x="490" y="95" fill="var(--cyber-neon-green)" fontSize="14">
            150
          </text>
          <text
            x="445"
        ...
        >
          <path
            ...
            strokeWidth="2"
            strokeDasharray="5,5"
            markerEnd="url(#arrowhead-varint)"
        ...
        >
          <path
            ...
            strokeWidth="2"
            strokeDasharray="5,5"
            markerEnd="url(#arrowhead-pink-varint)"
            className="opacity-60"
          />
        </motion.g>
        ...
        >
          <rect
            ...
            rx="8"
            fill="var(--panel-bg)"
            stroke="url(#cyber-gradient-varint)"
            strokeWidth="2"
            filter="url(#glow-varint)"
            opacity="0.9"
          />
          ...
          <g transform="translate(190, 355)">
            ...
            >
              ...
              <tspan fill="var(--cyber-neon-pink)">000</tspan>
            </text>
            <text
              x="45"
              y="24"
            ...
            >
              <tspan fill="var(--cyber-neon-green)">1</tspan>
              <tspan fill="currentColor">0010110</tspan>{" "}
              <tspan fill="var(--cyber-neon-green)">0</tspan>
              <tspan fill="currentColor">0000001</tspan>
            </text>
            <text
              x="220"
              y="24"
...
export default VarintWireTypeVisualization;
